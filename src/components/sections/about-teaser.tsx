  ...
  return (
    <section id="about" className="mx-auto max-w-site scroll-mt-24 px-5 pb-28">
      <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
        <Reveal className="relative aspect-[4/5] overflow-hidden rounded-[28px] border border-glass-line shadow-[0_40px_100px_--alpha(var(--color-shade)/50%),0_0_80px_--alpha(var(--color-glow)/8%)]">
          <Image
            src="/me/portrait.jpg"
          ...
          />
          <span className="absolute bottom-4 left-4 rounded-full border border-glass-line bg-scrim/75 px-3 py-1.5 text-xs text-muted backdrop-blur-md">
